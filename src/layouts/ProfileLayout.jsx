        ...
        <div className="relative max-w-4xl mx-auto px-6 py-12">
          <div className="flex items-end gap-6">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-brand-500 rounded-full border-4 border-surface-50" />
            </div>
          ...
          <div className="flex items-center gap-8 mt-6 pt-6 border-t border-surface-200/60">
            {[
