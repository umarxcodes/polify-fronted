...
const preferenceFields = [
  {
    ...
    description: "Receive account and moderation updates by email",
  },
  {
  ...
  {
    key: "voteNotifications",
    label: "Vote activity",
    description: "Get notified when someone votes on your polls",
  },
  {
    key: "commentNotifications",
    label: "Comments and replies",
    description: "Get notified about comments and replies",
  },
  {
    key: "pollNotifications",
    label: "Poll updates",
    description: "Get notified when polls you follow change or close",
  },
  {
    key: "systemNotifications",
    label: "System announcements",
    description: "Receive important service notifications",
  },
  {
    key: "marketingNotifications",
    label: "Product updates",
    description: "Receive occasional Pollify news and tips",
  },
];
    ...
    const fetchSettings = async () => {
      try {
        ...
        const storedPreferences =
          preferencesResponse.data?.data?.preferences;
              ...
              <Card className="p-6">
                ...
                <div className="space-y-6">
                  {preferenceFields.map((setting) => (
                    <div
                      key={setting.label}
                      className="flex items-center justify-between py-3 border-b border-surface-200 last:border-b-0"
                    >
                      <div>
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(enabled) =>
                          updatePreference(setting.key, enabled)
                        }
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Allow other users to mention you",
                      enabled: true,
                    },
                  ].map((setting) => (
                    <div
