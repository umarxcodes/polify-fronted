    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">Followers</h1>
        </div>
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Followers</h1>
          <p className="text-surface-400 mt-1">People following @{username}</p>
        </div>
      </div>
      ...
      <Card dark className="p-6">
        {users.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-surface-400">No followers yet</p>
          </div>
        )}
      </Card>
    </div>
