...
function ProfileHeader({ user }) {
  ...
  return (
    <div className="relative bg-linear-to-br from-brand-500/10 via-surface-50 to-violet-500/10 border-b border-surface-200/60">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-12">
        <div className="flex items-end gap-6">
          ...
          >
            <div className="w-24 h-24 rounded-2xl bg-linear-to-br from-brand-400 to-brand-600 flex items-center justify-center text-white text-2xl font-bold shadow-xl shadow-brand-500/25">
              {initials}
            </div>
