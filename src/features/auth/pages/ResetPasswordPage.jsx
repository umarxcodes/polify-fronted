  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-surface-900 tracking-tight">Choose a new password</h1>
        <p className="text-surface-500 mt-2">Create a password you don't use elsewhere.</p>
      </div>
