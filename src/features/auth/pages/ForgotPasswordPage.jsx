  ...
  if (sent) {
    return (
      ...
      >
        ...
        <p className="text-surface-500 mb-6">If an account exists for that email, we've sent reset instructions.</p>
        <Link to="/login">
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-surface-900 tracking-tight">Reset your password</h1>
        <p className="text-surface-500 mt-2">We'll email you a secure reset link.</p>
      </div>
